                            ...
                            <div class="col-md-6">
                                ...
                                <select name="company" id="company" class="form-control">
                                    ...
                                    @foreach($companies as $company)
                                        <option value={{$company->id}}><img src={{$company->logo}}  alt=""/> {{$company->name}}</option>
                                    @endforeach
                        ...
                        <div id="questions" class="my-4">
                            <div class="question row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="questions[1][type]" class="form-control question-type" onchange="toggleOptions($(this))">
                                ...
                                <div class="col-md-12 question-options my-3" >
                                    <label>Options:</label>
                                    <div class="options-container my-3">
                                        <input type="text" name="questions[1][options][]" class="form-control" placeholder="Option 1">
                                    </div>
